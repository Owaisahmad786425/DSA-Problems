<h1>3738 - Make Array Non-decreasing</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/make-array-non-decreasing/">make-array-non-decreasing</a></h2><p>You are given an integer array <code>nums</code>. In one operation, you can select a <span data-keyword="subarray-nonempty">subarray</span> and replace it with a single element equal to its <strong>maximum</strong> value.</p>
